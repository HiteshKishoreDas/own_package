...
def plot_streamline  ( img_data_x, img_data_y,\
                       view_dir: int = 2, \
                       mode:str = 'slice', \
                       x_data = None, y_data=None, z_data=None, \
                       z_slice: int = None,\
    ...
    slc = ax.streamplot(x_data, y_data, stream_data_x, stream_data_y, \
...
def plot_line_integral_convolution( img_data_x, img_data_y,\
                       view_dir: int = 2, \
                       mode:str = 'slice', \
                       x_data = None, y_data=None, z_data=None, \
                       z_slice: int = None,\
    ...
    slc = ax.pcolormesh(x_data, y_data, lic_result, \
                    cmap='gray', alpha = alpha_arr, **kwargs  )
...
if __name__ == "__main__":
    ...
    plot_dict = plot_streamline(v1[:10,:20,:30], v2[:10,:20,:30], mode='average',view_dir=1 , \
                                new_fig=False, ax=plot_dict['ax'], fig=plot_dict['fig'])
    # plot_dict['cbar'].set_label('Colorbar label') 
    plot_dict['ax'].set_title('plot_projection test') 
    plot_dict['ax'].set_xlabel('x label') 
    plot_dict['ax'].set_ylabel('y label') 
    ...
    plot_dict = plot_line_integral_convolution(v1, v2, mode='average',view_dir=1,\
                                new_fig=False, ax=plot_dict['ax'], fig=plot_dict['fig'])
    # plot_dict['cbar'].set_label('Colorbar label') 
