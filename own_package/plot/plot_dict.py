...
def plot_dict_create(field_list, quant_dict):
    ...
    if "rho" or "all" in field_list:
        ...
        quant_dict["rho"][
            "save_loc"
        ] = f"{sim_loc}Plots/slices/rho/rho_{str(n_snap).zfill(5)}.png"
    ...
    if "prs" or "all" in field_list:
        ...
        quant_dict["prs"][
            "save_loc"
        ] = f"{sim_loc}Plots/slices/prs/prs_{str(n_snap).zfill(5)}.png"
    ...
    if "logT" or "all" in field_list:
        ...
        quant_dict["logT"][
            "save_loc"
        ] = f"{sim_loc}Plots/slices/logT/logT_{str(n_snap).zfill(5)}.png"
    ...
    if "vx" or "all" in field_list:
        ...
        quant_dict["vx"][
            "save_loc"
        ] = f"{sim_loc}Plots/slices/vx/vx_{str(n_snap).zfill(5)}.png"
    ...
    if "vy" or "all" in field_list:
        ...
        quant_dict["vy"][
            "save_loc"
        ] = f"{sim_loc}Plots/slices/vy/vy_{str(n_snap).zfill(5)}.png"
    ...
    if "vz" or "all" in field_list:
        ...
        quant_dict["vz"][
            "save_loc"
        ] = f"{sim_loc}Plots/slices/vz/vz_{str(n_snap).zfill(5)}.png"
    ...
    if MHD_flag and ("Bx" or "all" in field_list):
        ...
        quant_dict["Bx"][
            "save_loc"
        ] = f"{sim_loc}Plots/slices/Bx/Bx_{str(n_snap).zfill(5)}.png"
    ...
    if MHD_flag and ("By" or "all" in field_list):
        ...
        quant_dict["By"][
            "save_loc"
        ] = f"{sim_loc}Plots/slices/By/By_{str(n_snap).zfill(5)}.png"
    ...
    if MHD_flag and ("Bz" or "all" in field_list):
        ...
        quant_dict["Bz"][
            "save_loc"
        ] = f"{sim_loc}Plots/slices/Bz/Bz_{str(n_snap).zfill(5)}.png"
