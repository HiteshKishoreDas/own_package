...
if __name__ == "__main__":
    ...
    file_loc1 = wdir_loc + 'Turbulence/para_scan_Rlsh4_500_res0_256_rseed_1_M_0.5_beta_100/'
    file_loc2 = wdir_loc + 'Turbulence/para_scan_Rlsh4_500_res0_256_rseed_1_M_0.25_beta_100/'
    file_loc3 = wdir_loc + 'Turbulence/para_scan_Rlsh1_500_res0_256_rseed_1_M_0.9_beta_100/'
    ...
    arg_dict = {}
    arg_dict['file_list']      = [file_loc1     , file_loc2    , file_loc3    ]
    arg_dict['MHD_list' ]      = [True          , True         , True         ]
    arg_dict['ncells_list']    = [[256,256,256] , [256,256,256], [256,256,256]]
    # arg_dict['ncells_list']    = [[128,128,128] , [128,128,128], [128,128,128]]
    arg_dict['cool_flag_list'] = [False         , False        , False        ]
    arg_dict['label_list']     = [r'$\mathcal{M = 0.5}$', r'$\mathcal{M = 0.25}$', r'$\mathcal{M = 0.9}$']
    # arg_dict['label_list']     = [r'$f_{\rm shear} = 0.1$', r'$f_{\rm shear} = 0.3$', r'$f_{\rm shear} = 1.0$']
    arg_dict['normalise_list'] = {'x_norm':[const/0.5,const/0.25,const/0.9], 'y_norm':[None]}
    # arg_dict['normalise_list'] = {'x_norm':[const/0.5,const/0.5,const/0.5], 'y_norm':[None]}

    # fig,ax = plot_time_evolution(y_func = turb_vel , **arg_dict )
    # plt.show()
